...
> **Project status:** Early open-source release. v0.8.0 is usable today, but interfaces and configuration may change while the project moves toward a stable release.
...
npm install
npm run package
code --install-extension pide-0.8.0.vsix --force
```
